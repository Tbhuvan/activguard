...
### Static Benchmark (198 pairs, 8 CWE classes — complete code fragments)

| Tool | Recall | Precision | AUC |
|------|--------|-----------|-----|
| **ActivGuard** | **100%†** | **100%†** | **0.835** |
| Bandit (≥MEDIUM) | 41.9% (83/198) | 60.6% | — |
| Semgrep (p/python) | ~14%‡ | 51.0% | — |

†*In-sample evaluation — the same training pairs used for probe fitting. Held-out metric: AUC 0.835 ± 0.055 (5-fold CV, 198 pairs). Bandit threshold: MEDIUM (standard CI/CD setting); HIGH misses B608/SQLi entirely.*
